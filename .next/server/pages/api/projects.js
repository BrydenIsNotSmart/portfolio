...
/***/ "(api)/./src/pages/api/projects.js":
/*!***********************************!*\
  !*** ./src/pages/api/projects.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst Softwareer = __webpack_require__(/*! libraries/softwareer.node */ \"(api)/./src/libraries/softwareer.node.js\");\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((req, res)=>{\n    let page = req.query?.page || 1;\n    let limit = req.query?.limit || 10;\n    page = parseInt(page);\n    limit = parseInt(limit);\n    Softwareer.getProjects(page, limit).then((profile)=>{\n        res.status(200).json({\n            success: true,\n            message: null,\n            data: profile\n        });\n    }).catch((error)=>{\n        res.status(500).json({\n            success: false,\n            message: \"Something went wrong\",\n            data: null\n        });\n    });\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./src/pages/api/projects.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./src/pages/api/projects.js"));
